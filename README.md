...
- Module 4: OOP - Java, Programming Logic, Software Development Life Cycle (SDLC).
- Module 5: Cloud Computing Fundamentals, Virtualization, Cloud Services (IaaS, PaaS, SaaS), Cloud Deployment Models, Kunernetes Basics. Contenizerization with Docker.
